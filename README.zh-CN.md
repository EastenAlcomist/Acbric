...
当前 API 构建为 **0.3.3-dev.6**。本轮新增运行期事件诊断与受管理订阅范围；继续提供配置、战役生命周期和存档/恢复集成，保留已有公开成员和事件语义。
...
标准构建有 311 项无界面回归，含 81 项订阅范围、27 项运行期诊断及原 62 项配置检查。用户对 dev.4 反馈暂未发现问题，未提供完整逐项清单；dev.6 GUI 与真实双机验收仍待人工完成。
