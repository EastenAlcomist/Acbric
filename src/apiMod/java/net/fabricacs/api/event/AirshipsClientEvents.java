...
public final class AirshipsClientEvents {
    ...
    public static final Event<ClientTickStart> CLIENT_TICK_START = new Event<>("AirshipsClientEvents.CLIENT_TICK_START", listeners -> game -> {
    ...
    public static final Event<ClientTickEnd> CLIENT_TICK_END = new Event<>("AirshipsClientEvents.CLIENT_TICK_END", listeners -> game -> {
