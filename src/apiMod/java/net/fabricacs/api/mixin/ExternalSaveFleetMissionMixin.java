/* ExternalSaveFleetMissionMixin.java — 舰队编辑器沿用统一本地 MOD 目录，其他文件位置保持原生逻辑。 */
...
@Mixin(targets = "com.zarkonnen.airships.FleetCreationScreen$SaveFleetMission", remap = false)
public abstract class ExternalSaveFleetMissionMixin {
